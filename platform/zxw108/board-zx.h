...
#define LED_D2 PORTx_PIN(boardDescription->io->leds[2].gpioPort, boardDescription->io->leds[2].gpioPin) // PORTB_PIN(5)
#define LED_D4 PORTx_PIN(boardDescription->io->leds[3].gpioPort, boardDescription->io->leds[3].gpioPin) // PORTB_PIN(5)
